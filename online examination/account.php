...
<a href="#" data-toggle="modal" data-target="#developers" s style="color:lightyellow;" onmouseover="this.style('color:yellow')" target="new">Organized by talay3</a>
</div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="col-md-4">
		 ...
		 <div class="col-md-5">
		<a href="" style="color:#202020; font-family:'typo' ; font-size:18px" title=""></a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">01099318155</h4>
		<h4 style="font-family:'typo' ">usf@gmail.com</h4>
		<h4 style="font-family:'typo' ">kfs university </h4></div></div>
		</p>
      </div>
