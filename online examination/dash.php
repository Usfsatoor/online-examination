...
<title> Admin || online examination</title>
...
if (@$_GET['q'] == 4)
    echo 'class="active"';
?>><a href="dash.php?q=4">Add question</a></li>
        <li <?php
if (@$_GET['q'] == 5)
    echo 'class="active"';
?>><a href="dash.php?q=5">Remove question</a></li>
      </ul>
          </div>
  </div>
</nav>
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <input id="name" name="name" placeholder="Enter question title" class="form-control input-md" type="text">
