...
<div style="background-image: url('image/bg5.jpg'); background-repeat: no-repeat; background-size: cover; background-position: center;">
<div class="row">

<div class="col-md-7"></div>
<div class="col-md-4 panel"> 
  <form  class="form-vertical" name="form" action="sign.php?q=account.php" onSubmit="return validateForm()" method="POST">
<fieldset >
<div class="form-group">
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <input id="rollno" name="rollno" placeholder="enter Your ID " class="form-control input-md" type="text" value="<?php
